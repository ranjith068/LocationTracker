...
import com.locationtracker.LocationModel;
...
//                appendLog(DateFormat.getDateTimeInstance().format(new Date()) + ": Started", Constants.LOG_FILE);
    ...
    public void onLocationChanged(Location location) {
        ...
        Toast.makeText(BackgroundLocationService.this, " location = " + latitude+","+longitude, Toast.LENGTH_SHORT).show();

        // Creating a LatLng object for the current location
//        LatLng latLng = new LatLng(latitude, longitude);

        Database databaseHandler = new Database(getApplicationContext());
        databaseHandler.addLocation(new LocationModel(String.valueOf(latitude) + "," + String.valueOf(longitude)));
